...
<head>
    ...
    <style>
        ...
        /* EXECUTIVE SUMMARY */
        .exec-summary { width: 100%; border-collapse: collapse; margin-bottom: 30px; }
        .exec-summary td { width: 33.33%; padding: 15px; text-align: center; border: 1px solid #e2e8f0; background-color: #f8fafc; }
        .exec-summary .title { font-size: 10px; color: #64748b; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; display: block; }
        ...
        /* HEADER KARTU (WARNA GELAP SEPERTI FLEET CMDR) */
